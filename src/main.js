...
// Текст песни с переносами строк
...
const RainbowText = () => {
  ...
  useEffect(() => {
    ...
    }, 1000); // Изменение активной строки каждые 2 секунды
  ...
  return (
    <div style={{
        ...
        backgroundSize: 'cover', // Покрытие фона
        backgroundPosition: 'center', // Центрирование фона
        padding: '50px 0' // Добавление внутренних отступов для визуального разделения
      }}>
